...
const ERROR_MESSAGES: Record<string, string> = {
  oauth_not_configured:
    "Discord OAuth isn't configured on the server (missing DISCORD_CLIENT_ID / DISCORD_CLIENT_SECRET).",
  oauth_error: "Discord returned an error. Try again.",
  no_code: "Discord didn't return an authorization code. Try again.",
  invalid_state:
    "OAuth state didn't match. Your session may have expired — try again.",
